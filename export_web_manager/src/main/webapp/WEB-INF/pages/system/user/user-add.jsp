        ...
        <div class="panel panel-default">
            ...
            <form id="editForm" action="/system/user/edit.do" method="post">
                ...
                <div class="row data-type" style="margin: 0px">
                    ...
                    <div class="col-md-4 data" style="font-size: 15px;height: 80px">
                        <div class="form-group form-inline">
                            <div class="radio"><label><input type="radio" ${user.degree==0?'checked':''} name="degree" value="1">saas管理员</label></div>
                            <div class="radio"><label><input type="radio" ${user.degree==1?'checked':''} name="degree" value="1">企业管理员</label></div>
                            <div class="radio"><label><input type="radio" ${user.degree==2?'checked':''} name="degree" value="2">大区经理</label></div>
