...
public class ContractPrudctVo implements Serializable {
    ...
    public ContractPrudctVo() {
    }

    public ContractPrudctVo(String customName, String contractNo, String productNo, Integer cnumber, String factoryName, Date deliveryPeriod, Date shipTime, String tradeTerms) {
